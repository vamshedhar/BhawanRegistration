...
<title>Year and Branch-wise list</title>
</head>
...
<tr><td colspan="14"><h3 align="center">List of <?php echo $_POST['programme']; ?> <?php echo $_POST['year']; ?> Year Students</h3></td></tr>
<tr>
...
$result = mysql_query("SELECT * FROM signupug WHERE programme='$_POST[programme]' AND year='$_POST[year]' ORDER BY userKey ASC");
echo mysql_error();
$a = 1;
